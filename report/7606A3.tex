...
\title{DASC7606-Assignment\#3\\ Experiments on hyperparamter tuning in LLM} % Article title, use manual lines breaks (\\) to beautify the layout
...
% 	\includegraphics[width=\linewidth]{16forward_plot.png}
